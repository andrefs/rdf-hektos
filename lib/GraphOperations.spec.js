...
describe('_randomWalk', () => {
  test('finds loop', async() => {
    store.select
      .mockReturnValueOnce(wrapReadable([{'?o': rdf.namedNode(`${pf}/N3`)}]))
      .mockReturnValueOnce(wrapReadable([{'?o': rdf.namedNode(`${pf}/N4`)}]))
      .mockReturnValueOnce(wrapReadable([{'?o': rdf.namedNode(`${pf}/N2`)}]))
      .mockReturnValueOnce(wrapReadable([{'?o': rdf.namedNode(`${pf}/N1`)}]));
  ...
  test('finishes early', async () => {
    store.select
      .mockReturnValueOnce(wrapReadable([{'?o': rdf.namedNode(`${pf}/N11`)}]))
      .mockReturnValueOnce(wrapReadable([{'?o': rdf.namedNode(`${pf}/N12`)}]))
  ...
  test('finds literal', async () => {
    store.select
      .mockReturnValueOnce(wrapReadable([{'?o': rdf.literal('L1')}]))
