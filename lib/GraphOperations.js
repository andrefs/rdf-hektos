import {Query, COUNT, V, N, B, L, RAND} from './QueryBuilder.js';
...
class GraphOperations extends EventEmitter {
  ...
  constructor(repo, host='http://localhost', port='7201'){
    super();
    this._handleEvents();
    const endpointUrl = `${host}:${port}/repositories/${repo}`;
    this._store = new Store({endpointUrl});
  }
