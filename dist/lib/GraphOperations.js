...
class GraphOperations extends events_1.default {
    ...
    rightRWStep(s, p, o) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const q = new QueryBuilder_1.Query().select(o)
    ...
    leftRWStep(s, p, o) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const q = new QueryBuilder_1.Query().select(s)
    ...
    _randSelectSubjects(p, howMany) {
        return __awaiter(this, void 0, void 0, function* () {
            const q = new QueryBuilder_1.Query().distinct().select('x')
    ...
    calcSubjectCoverage(subSelect) {
        return __awaiter(this, void 0, void 0, function* () {
            const q = new QueryBuilder_1.Query().select('p', (0, QueryBuilder_1.COUNT)('s', 'cov'))
    ...
    calcObjectCoverage(subSelect) {
        return __awaiter(this, void 0, void 0, function* () {
            const q = new QueryBuilder_1.Query().select('p', (0, QueryBuilder_1.COUNT)('o', 'cov'))
                .where((0, QueryBuilder_1.Q)((0, QueryBuilder_1.V)('s'), (0, QueryBuilder_1.V)('p'), (0, QueryBuilder_1.V)('o')), subSelect)
                .groupBy('p');
            const cov = yield this._runQuery(q);
            return Object.fromEntries(cov.map(c => { var _a, _b; return [(_a = c.get('p')) === null || _a === void 0 ? void 0 : _a.value, Number((_b = c.get('cov')) === null || _b === void 0 ? void 0 : _b.value)]; }));
